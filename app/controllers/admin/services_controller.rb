class Admin::ServicesController < AdminController
  ...
  #     redirect_to new_admin_service_path, flash: { error: t('shared.msgs.missing_parameter') }
  #   else
  ...
  def create
    ...
    respond_to do |format|
      if @item.save
        format.html do
          redirect_to manage_services_path, flash: {
  ...
  def update
    ...
    respond_to do |format|
      if @item.update_attributes(pars)
        ...
        format.html do
          redirect_to manage_service_path(id: @item.id), flash: {
  ...
  private
    def pars
      permitted = Service.globalize_attribute_names + [:icon, :color]
