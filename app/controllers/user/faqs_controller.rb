class User::FaqsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @faq.update(faq_params)
        format.html { redirect_to user_faqs_path, notice: 'This question/answer was successfully updated.' }
  ...
  def destroy
    @faq.destroy
    respond_to do |format|
      format.html { redirect_to user_faqs_path, notice: 'Question successfully deleted.' }
      format.json { head :no_content }
    end
  end
