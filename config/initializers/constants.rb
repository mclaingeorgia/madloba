...
# MAPBOX_TILES_URL='https://{s}.tiles.mapbox.com/v4/%{mapbox_map_id}/{z}/{x}/{y}.png?access_token=%{api_key}'
...
# OSM_NOMINATIM_URL = 'http://nominatim.openstreetmap.org/search?q=%{location}&format=json&polygon=0&addressdetails=0&accept-language=%{language}'
